...
<title>Penn Taekwondo Tournament</title>
...
<div id="container">
  <div id="header">
    <h1 align="center"><img src="images/TKDLogo.gif" alt="Penn TKD" width="800" height="90" /></h1>
  <!-- end #header --></div>
  <div id="mainContent">
    ...
    <ul>
      ...
      <li><a href="screen3.php">screen3</a></li>
    ...
    <h2>Files</h2>
    <p>Turn off Screensavers!!!</p>
    <ul>
      <li><a href="poomse/">Poomse Directory</a></li>
      <li>Poomsae Blank Form (<a href="downloads/Forms.xlsx">xlsx</a>)</li>
